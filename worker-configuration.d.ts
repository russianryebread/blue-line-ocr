/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df9537e89246303409f4233570e83736)
// Runtime types generated with workerd@1.20260801.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	ASSETS: Fetcher;
	SCORECARD_DEBUG: "false";
	HISTORICAL_API_URL: "";
	LOG_LEVEL: string;
	VISION_MODEL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SCORECARD_DEBUG" | "HISTORICAL_API_URL" | "LOG_LEVEL" | "VISION_MODEL" | "MOONSHOT_API_KEY">> {}
}
